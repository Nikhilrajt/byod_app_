...
class CarouselManagementWidget extends StatefulWidget {
  final String collectionName;

  const CarouselManagementWidget({super.key, required this.collectionName});

  @override
  State<CarouselManagementWidget> createState() =>
      _CarouselManagementWidgetState();
}

class _CarouselManagementWidgetState extends State<CarouselManagementWidget> {
  ...
  Future<void> _deleteBanner(String docId) async {
    try {
      await _firestore.collection(widget.collectionName).doc(docId).delete();
      if (mounted) {
        ScaffoldMessenger.of(
          context,
